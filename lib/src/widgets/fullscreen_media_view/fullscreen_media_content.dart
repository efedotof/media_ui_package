    ...
    if (mediaGridCubit != null) {
      return BlocBuilder<MediaGridCubit, MediaGridState>(
        builder: (context, state) {
          return _buildMediaGridContent(context, state);
        },
      );
    } else {
      return BlocBuilder<FullScreenMediaCubit, FullScreenMediaState>(
        builder: (context, state) {
          return _buildFullScreenContent(context, state);
        },
      );
    }
  }

  Widget _buildMediaGridContent(BuildContext context, MediaGridState state) {
    ...
    return state.when(
      ...
      permissionDenied: () =>
          ErrorsWidget(screenSize: screenSize, message: 'Permission denied'),
      error: (message) =>
